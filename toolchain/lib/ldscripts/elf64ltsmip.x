...
OUTPUT_ARCH(mips)
ENTRY(__start)
SEARCH_DIR("/home/pic32/toolchain/crosstool-ng-1.21.0/../../pic32_br_bsp/toolchain/mipsel-mchp-linux-uclibc/lib64"); SEARCH_DIR("=/usr/local/lib64"); SEARCH_DIR("=/lib64"); SEARCH_DIR("=/usr/lib64"); SEARCH_DIR("=/usr/local/lib"); SEARCH_DIR("=/lib"); SEARCH_DIR("=/usr/lib");
SECTIONS
{
